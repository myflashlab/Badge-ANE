package 
{
	...
	public class Main extends Sprite 
	{
		...
		public function Main():void 
		{
			...
			_txt.htmlText = "<font face='Arimo' color='#333333' size='20'><b>Badge ANE for Adobe Air V"+Badge.VERSION+"</font>";
		...
		private function init():void
		{
			...
			var btn1:MySprite = createBtn("increase badge by 1 value");
			btn1.addEventListener(MouseEvent.CLICK, increase);
			_list.add(btn1);
			...
			function increase(e:MouseEvent):void
			{
				...
				C.log("current badge is: " + Badge.value);
			}
			
			//----------------------------------------------------------------------
			
			var btn2:MySprite = createBtn("decrease badge by 1 value");
			btn2.addEventListener(MouseEvent.CLICK, decrease);
			_list.add(btn2);
